...
namespace GridCellTemperature
{
	public class Settings : ModSettings
	{
		...
		public static readonly Setting<float> skyDiffusivity = new(nameof(skyDiffusivity), 0.3f);
		public static readonly Setting<float> roofDiffusivity = new(nameof(roofDiffusivity), 0.025f);
		public static readonly Setting<float> thickRoofDiffusivity = new(nameof(thickRoofDiffusivity), 0.015f);
